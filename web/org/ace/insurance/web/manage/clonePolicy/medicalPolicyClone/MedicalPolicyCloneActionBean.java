package org.ace.insurance.web.manage.clonePolicy.medicalPolicyClone;
...
@ViewScoped
@ManagedBean(name = "MedicalPolicyCloneActionBean")
public class MedicalPolicyCloneActionBean extends BaseBean {
	...
	private boolean inputCheck(MedicalPolicyCriteria policyCriteria) {
		boolean result = true;
		String formId = "medicalCloneForm";
	...
	public void prepareToClonePolicy(MPL001 policyDTO) {
		this.policyDTO = policyDTO;
	}

	public String clonePolicy() {
