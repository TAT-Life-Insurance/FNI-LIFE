...
public class AddNewLifeConfirmationActionBean extends BaseBean implements Serializable {
	...
	public void init() {
		...
		isUserDefinedDate = isEndownmentLife || isShortTermEndownment || isSportMan ? true : false;
	...
	*//**
	 ...
	 *//**
		 ...
		 * @return String
		 *//*
		 * public String getSportManMessage() { Double available = availableSI +
		 * getAvailableSISportMan(); DateFormat df = new
		 * SimpleDateFormat("dd-MMM-yyyy"); return "You will have to wait till "
		 * + df.format(minEndDate) + " to allow the sum insured amount at " +
		 * available + "."; }
		 */
