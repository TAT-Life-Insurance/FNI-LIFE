			...
			for (PolicyInsuredPerson insuPerson : lifeProposal.getLifePolicy().getInsuredPersonInfo()) {
				...
				if (insuPersonHistory != null) {
					if (lifeProposal.getLifePolicy().getPolicyStatus() == PolicyStatus.UPDATE) {
						...
						if (lifeProposal.getLifePolicy().getPeriodMonth() != lifeProposal.getLifePolicy().getPeriodMonth()) {
							i = i + 1;
							desc += "<tr>" + "<td>" + fontStart + i + ". " + fontEnd + "</td>" + "<td>" + fontStart + "Period " + fontEnd + "</td>" + "<td>" + fontStart + "-   "
									+ lifeProposal.getLifePolicy().getPeriodMonth() + " years" + fontEnd + "</td>" + "<td width=\"30\" align=\"center\">" + fontStart + "To"
									+ fontEnd + "</td>" + "<td>" + fontStart + lifeProposal.getLifePolicy().getPeriodMonth() + " years" + fontEnd + "</td>" + "</tr>";
						}
					} else {
					...
					desc += "<tr>" + "<td>" + fontStart + i + ". " + fontEnd + "</td>" + "<td>" + fontStart + "New Insured Person" + fontEnd + "</td>" + "<td>" + fontStart + " - "
							...
							+ lifeProposal.getLifePolicy().getPeriodMonth() + " years" + fontEnd + "</td>" + "</tr>";
				}
			}
		}
		desc += "</table>";
	...
	public void saveEndorsementPolicyPrint() {
		try {
			if (validEndorsementPolicyPrint()) {
				...
				RequestContext.getCurrentInstance().execute("endorsementSetUpEntryDialog.hide()");
			}
		} catch (SystemException ex) {
			handelSysException(ex);
		}
