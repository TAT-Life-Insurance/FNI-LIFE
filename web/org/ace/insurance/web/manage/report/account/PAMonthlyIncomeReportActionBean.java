...
@ViewScoped
@ManagedBean(name = "PAMonthlyIncomeReportActionBean")
public class PAMonthlyIncomeReportActionBean extends BaseBean implements Serializable {
	...
	private List<PAMonthlyIncomeReportDTO> paMonthlyIncomeReportDTOList;
	private User user;
	...
	public void resetCriteria() {
		...
		paMonthlyIncomeReportDTOList = new ArrayList<PAMonthlyIncomeReportDTO>();
	}

	public void filter() {
		paMonthlyIncomeReportDTOList = tlfService.findPAMonthlyIncomeReport(criteria);
	}
	...
	public void exportExcel() {
		...
		String fileName = "PAMonthlyIncomeReport.xlsx";
		ec.setResponseHeader("Content-Disposition", "attachment; filename=\"" + fileName + "\"");
		try (OutputStream op = ec.getResponseOutputStream();) {
			PAMonthlyIncomeReportExcel paMonthlyExcel = new PAMonthlyIncomeReportExcel();
			paMonthlyExcel.generate(op, paMonthlyIncomeReportDTOList);
			getFacesContext().responseComplete();
		} catch (IOException e) {
			throw new SystemException(ErrorCode.SYSTEM_ERROR, "Failed to export paMonthlyReportExcel.xlsx", e);
		}
	}
	...
	public List<PAMonthlyIncomeReportDTO> getPaMonthlyIncomeReportDTOList() {
		return paMonthlyIncomeReportDTOList;
	}
