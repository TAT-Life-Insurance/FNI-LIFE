 ...
 *    
 ***************************************************************************************/
package org.ace.insurance.system.common.industry;
...
@NamedQueries(value = { @NamedQuery(name = "Industry.findAll", query = "SELECT o FROM Industry o ORDER BY o.name ASC"),
		@NamedQuery(name = "Industry.findById", query = "SELECT o FROM Industry o WHERE o.id = :id") })
