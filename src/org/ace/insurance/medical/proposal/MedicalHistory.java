...
@TableGenerator(name = "MEDICALHISTORY_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "MEDICALHISTORY_GEN", allocationSize = 10)
@NamedQueries(value = { @NamedQuery(name = "MedicalHistory.findAll", query = "SELECT l FROM MedicalHistory l "),
		@NamedQuery(name = "MedicalHistory.findById", query = "SELECT l FROM MedicalHistory l WHERE l.id = :id") })
...
public class MedicalHistory {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((causeOfHospitalization == null) ? 0 : causeOfHospitalization.hashCode());
