...
//MZP
	...
	// ClaimInitialReport medicalClaimInitialReport =
	// MedicalClaimInitialReportFactory.createMedicalClaimInitialReport(medicalClaimInitialReportDTO);
	// try {
	// for (ICD10 icd : icdList) {
	// ClaimInitialReportICD claimInitialReportICD = new
	// ClaimInitialReportICD();
	...
	// }
	// String claimInitialNo =
	// customIDGenerator.getNextId(SystemConstants.INITIAL_REPORT_NO, null);
