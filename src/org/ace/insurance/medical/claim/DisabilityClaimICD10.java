...
@Entity
@Table(name = TableName.DISABILITY_CLAIM_ICD)
@TableGenerator(name = "DISABILITY_CLAIM_ICD_GEN", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", pkColumnValue = "DISABILITY_CLAIM_ICD_GEN", allocationSize = 10)
@EntityListeners(IDInterceptor.class)
public class DisabilityClaimICD10 {

	@Id
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "DISABILITY_CLAIM_ICD_GEN")
	private String id;
	...
	@JoinColumn(name = "MEDICATIONCLAIM_ID", referencedColumnName = "ID")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DisabilityClaimICD10 other = (DisabilityClaimICD10) obj;
		if (recorder == null) {
