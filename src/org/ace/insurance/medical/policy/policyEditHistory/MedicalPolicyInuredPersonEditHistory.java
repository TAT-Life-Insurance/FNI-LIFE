...
public class MedicalPolicyInuredPersonEditHistory implements IInsuredItem, Serializable {
	...
	public MedicalPolicyInuredPersonEditHistory(MedicalProposalInsuredPerson insuredPerson) {
		this.dateOfBirth = insuredPerson.getCustomer().getDateOfBirth();
		this.customer = insuredPerson.getCustomer();
		this.product = insuredPerson.getProduct();
		this.premium = insuredPerson.getPremium();
	...
	public void setPolicyInsuredPersonBeneficiariesList(List<MedicalPolicyInsuredPersonBeneficiariesEditHistory> policyInsuredPersonBeneficiariesList) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MedicalPolicyInuredPersonEditHistory other = (MedicalPolicyInuredPersonEditHistory) obj;
