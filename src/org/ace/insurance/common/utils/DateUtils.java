...
import org.ace.insurance.web.common.ntw.mym.MymNumConstant;
...
public class DateUtils {
	...
	public static String getDateFormatStringStartWithMonth(Date date) {
	...
	public static Date getDateFromDate(Date date, int day) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	...
	public static int yearsBetween(Date startDate, Date endDate, boolean isTimeInclude, boolean isDayCount) {
		// reset time in calculation if isTimeInclude is false
		if (!isTimeInclude) {
			startDate = resetStartDate(startDate);
			endDate = resetStartDate(endDate);
	...
	public static Period getPeriod(Date startDate, Date endDate, boolean isTimeInclude, boolean isDayCount) {
		org.joda.time.PeriodType periodType = org.joda.time.PeriodType.yearMonthDay();
		if (isTimeInclude) {
			periodType = org.joda.time.PeriodType.yearMonthDayTime();
		}
	...
	/**
	 * @param if
	 *            month is 0, "" will returned.
	 */
	public static String getMonthWithMyanmarLanguage(Date date) {
		String genName = "";
		int month = date.getMonth();
		switch (month) {
			case 0:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_JANUARY);
				break;
			case 1:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_FEBRUARY);
				break;
			case 2:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_MARCH);
				break;
			case 3:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_APRIL);
				break;
			case 4:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_MAY);
				break;
			case 5:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_JUNE);
				break;
			case 6:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_JULY);
				break;
			case 7:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_AUGUST);
				break;
			case 8:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_SEPTEMBER);
				break;
			case 9:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_OCTOBER);
				break;
			case 10:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_NOVEMBER);
				break;
			case 11:
				genName = (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_MONTH_DECEMBER);
				break;
			default:
				genName = "";
		}
	...
	public static String getYearWithMyanmarLanguage(Date date) {
		String genName = "";
		String year = org.ace.insurance.common.Utils.getYearFormat(date);
		for (int i = 0; i < year.length(); i++) {
			switch (Integer.parseInt((String.valueOf((year.charAt(i)))))) {
				case 0:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_ZERO);
					break;
				case 1:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_ONE);
					break;
				case 2:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_TWO);
					break;
				case 3:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_TRHEE);
					break;
				case 4:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_FOUR);
					break;
				case 5:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_FIVE);
					break;
				case 6:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_SIX);
					break;
				case 7:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_SEVEN);
					break;
				case 8:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_EIGHT);
					break;
				case 9:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_NINE);
					break;
				default:
					genName += "";
			}
	...
	public static String getDayWithMyanmarLanguage(Date date) {
		String genName = "";
		String day = date.getDate() + "";
		for (int i = 0; i < day.length(); i++) {
			switch (Integer.parseInt((String.valueOf((day.charAt(i)))))) {
				case 0:
					genName += (String) properties.getProperty(MymNumConstant.MYANMAR_FONT_NUMBER_ZERO);
					break;
				case 1:
	...
	public static int getNumberOfDaysByPeriod(int period, PeriodType periodType) {
		int numberOfDays = period;
		if (periodType.equals(PeriodType.DAY)) {
			numberOfDays = period;
		} else if (periodType.equals(PeriodType.MONTH)) {
			Date todayDate = new Date();
			Date plusDate = addMonth(todayDate, period);
			DateTime startDate = new DateTime(todayDate);
			DateTime endDate = new DateTime(plusDate);
			numberOfDays = Days.daysBetween(startDate.toLocalDate(), endDate.toLocalDate()).getDays();
		} else {
			Date todayDate = new Date();
			Date plusDate = addYears(todayDate, period);
			DateTime startDate = new DateTime(todayDate);
			DateTime endDate = new DateTime(plusDate);
			numberOfDays = Days.daysBetween(startDate.toLocalDate(), endDate.toLocalDate()).getDays();
		}
	...
	public static Date getBudgetYearStartDate() {
		Calendar cal = Calendar.getInstance();
	...
	public static Date getBudgetYearEndDate() {
		Calendar cal = Calendar.getInstance();
