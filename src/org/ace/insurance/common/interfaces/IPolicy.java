...
/**
 * The contract which defines the basic behaviors that all Policy
...
public interface IPolicy {
	...
	/**
	 * Accessor to retrieve the status whether this policy instance is applied
	 * with Co-insurance.
	 * 
	 ...
	 * 
	 * @return An instance of {@link PaymentType} representing the type of
	 *         payment
	 */
	...
	/**
	 * Accessor to retrieve the address of customer to whom this policy belongs
	 * to.
	 * 
