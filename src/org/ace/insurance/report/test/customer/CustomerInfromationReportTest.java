...
public class CustomerInfromationReportTest {
	private static Logger logger = Logger.getLogger(CustomerInfromationReportTest.class);
	...
	//	customerInformationReportService = (ICustomerInformationReportService) factory.getBean("CustomerInformationReportService");
	...
	public void generateReport() {
		...
		//List<CustomerInformationReport> reportList = customerInformationReportService.findCustomerInformation(criteria);
