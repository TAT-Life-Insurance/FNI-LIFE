...
@Repository("ProposalSummaryReportDAO")
public class ProposalSummaryReportDAO extends BasicDAO implements IProposalSummaryReportDAO {
	...
	public List<ProposalSummaryReport> find(SummaryReportCriteria criteria) throws DAOException {
		List<ProposalSummaryReport> result = new ArrayList<ProposalSummaryReport>();
		...
		try {
			...
			laq.append(" SELECT COUNT(a.id),a.name FROM LifeProposalSummary a ");
			...
			lsq.append(" SELECT COUNT(s.id),s.name FROM LifeProposalSummary s ");
			...
			faq.append(" SELECT COUNT(a.id),a.name FROM FireProposalSummary a ");
			...
			fsq.append(" SELECT COUNT(s.id),s.name FROM FireProposalSummary s ");
			...
			maq.append(" SELECT COUNT(a.id),a.name FROM MotorProposalSummary a ");
			...
			msq.append(" SELECT COUNT(s.id),s.name FROM MotorProposalSummary s ");
			...
			result.add(new ProposalSummaryReport(salemanLifeList, agentLifeList, lifeProductList, "Life Insurance"));
			result.add(new ProposalSummaryReport(salemanMotorList, agentMotorList, motorProductList, "Motor Insurance"));
			result.add(new ProposalSummaryReport(salemanFireList, agentFireList, fireProductList, "Fire Insurance"));
